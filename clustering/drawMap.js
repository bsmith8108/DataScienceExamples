...
var MAP_TOPOLOGY_FILE = "oklahomaTopology.json";
// TODO: you'll need to clean the data and put it here.
var MAIN_CSV_FILE = "oklahoma_earthquakes.cleaned.csv";
var getMainDataXY = function(d) { return [d.longitude, d.latitude]; };

// Overlay info.  Used in the Oklahoma earthquakes example to show the injection wells.
var OVERLAY_CSV_FILE = "oklahoma_injection_wells.csv";
var OVERLAY_CHECKBOX_TEXT = "Show injection well sites: ";
var OVERLAY_CHECKBOX_ID = "checkboxWells";
var getOverlayXY = function(d) { return [d.LONGITUDE, d.LATITUDE]; }; 
var overlayR = 1;
...
// Cross filter info.
var getFilter1Field = function(d) { return d.year; };
var getFilter2Field = function(d) { return d.prefmag; };
var domainFilter1 = [1880,2015];
var domainFilter2 = [0,6];
var rangeFilter1 = [-1, 20*24-5];
...
var mainData;
function ready(error, topology, csv, csv2, csv3){
	...
	mainData = [];
        var i = 0;
	console.log("csv3 attributes: ")
	console.log(csv3[1].mean)
	...
	// get my calculated version of K
	var myK = kmeans_withK(currentPoints);
	// create the clustering with the version of K I calculated
